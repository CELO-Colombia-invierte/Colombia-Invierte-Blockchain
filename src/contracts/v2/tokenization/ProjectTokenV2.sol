  ...
  IProjectTokenV2
{
  ...
  function setRevenueModule(address module) external onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  function getPastVotes(
    address account,
    uint256 blockNumber
  ) public view override(VotesUpgradeable, IProjectTokenV2) returns (uint256) {
  ...
  function balanceOf(address account) public view override(ERC20Upgradeable, IProjectTokenV2) returns (uint256) {
    return super.balanceOf(account);
  }

  function totalSupply() public view override(ERC20Upgradeable, IProjectTokenV2) returns (uint256) {
